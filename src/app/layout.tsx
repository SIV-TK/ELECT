  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <head>
        ...
        <meta name="apple-mobile-web-app-title" content="Sauti Ya Watu" />
      ...
      <body className="font-body antialiased safe-top safe-bottom touch-manipulation tap-highlight-none">
        {/* Google Analytics */}
        <Script
