...
export default function DashboardPage() {
  return (
    <div className="flex flex-col gap-6">
      <Card>
        <CardHeader>
          <CardTitle className="font-headline text-3xl">Welcome to Sauti Ya Watu</CardTitle>
          <CardDescription>
        ...
        <CardContent>
          <p>
            Navigate through different sections using the sidebar to access detailed politician records, participate in demo voting, and explore our advanced AI-powered analytics.
          </p>
        </CardContent>
      </Card>
